...
CEFpars = ms.crysfipy.CEFpars('D4', [-1.35, 0.015, 0.53], 'meV')
...
if calculateTAS:
    ...
    ax.legend()
    fig.savefig('CeCu2Si2-TAS-mikibox.png',dpi=200)
...
if calculateMagnetism:
    ...
    ax.legend(title=f'CeCu$_2$Si$_2$ magnetization')
...
#    print(chi_100)
    ...
    ax.legend(title=f'CeCu$_2$Si$_2$ perturbation')
    ...
    ax.legend(title=f'CeCu$_2$Si$_2$, T={temperature} K')

    fig.savefig('CeCu2Si2-magnetism-mikibox.png',dpi=200)
